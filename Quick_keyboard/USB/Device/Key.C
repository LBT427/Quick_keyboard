...
UINT8 EC11_A_State = 0;
UINT8 EC11_A_PState = 0;
...
UINT8C key_code_map[3] = {
	0x31,0x32,0x33         //按键1,按键2,按键3,按键4,按键5,按键6
};
/*普通键盘数据*/
